                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group{{ $errors->has('customer') ? ' has-error' : '' }}">
                                <select id="customer" onchange="check_availability()" class="chosen form-control" name="customer" value="{{ old('customer') }}">
                                    ...
                                    @foreach($customers as $customer)
                                        <option @if($booking['customer']['id'] == $customer->id) selected @endif value="{{$customer->id}}">{{$customer->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="" id="customer_details">
                            <div class="col-md-12">
                                ...
                                <p class="col-md-7" id="name">{{$booking['customer']['name']}}</p>
                            </div>
                            <div class="col-md-12">
                                <label for="email_address" class="col-md-5 control-label">EmailAddress:</label>
                                <p class="col-md-7" id="email_address">{{$booking['customer']['email_address']}}</p>
                            </div>
                            <div class="col-md-12">
                                <label for="phone_number" class="col-md-5 control-label">PhoneNumber:</label>
                                <p class="col-md-7" id="phone_number">{{$booking['customer']['phone_number']}}</p>
                            </div>
                            <div class="col-md-12">
                                <label for="send_reminders" class="col-md-5 control-label">SendReminders:</label>
                                <p class="col-md-7" id="send_reminders">@if($booking['customer']['send_reminders']) Yes @else No @endif</p>
                            </div>
                            <div class="col-md-12">
                                <label for="is_student" class="col-md-5 control-label">IsStudent:</label>
                                <p class="col-md-7" id="is_student">@if($booking['customer']['is_student']) Yes @else No @endif</p>
                            </div>
                            <div class="col-md-12">
                                <label for="is_child" class="col-md-5 control-label">IsChild:</label>
                                <p class="col-md-7" id="is_child">@if($booking['customer']['is_child']) Yes @else No @endif</p>
                            </div>
                            <div class="col-md-12">
                                <label for="is_military" class="col-md-5 control-label">IsMilitary:</label>
                                <p class="col-md-7" id="is_military">@if($booking['customer']['is_military']) Yes @else No @endif</p>
                            </div>
                            <div class="col-md-12">
                                <label for="is_beard" class="col-md-5 control-label">HasBeard:</label>
                                <p class="col-md-7" id="is_beard">@if($booking['customer']['is_beard']) Yes @else No @endif</p>
                            </div>
                            <div class="col-md-12">
                                <label for="next_reminder" class="col-md-5 control-label">NextReminder:</label>
                                <p class="col-md-7" id="next_reminder">{{$booking['customer']['next_reminder']}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <label id="availability_heading">
                                Change the booking details to see availability
                            </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('stylist') ? ' has-error' : '' }}">
                                    ...
                                    <select id="stylist" onchange="check_availability()" class="form-control" name="stylist" value="{{ old('stylist') }}">
                                        ...
                                        @foreach($users as $user)
                                            <option @if($booking['user']['id'] == $user->id) selected @endif value="{{$user->id}}">{{$user->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group{{ $errors->has('start') ? ' has-error' : '' }}">
                                    ...
                                    <div class='input-group date' id='datetimepicker'>
                                        <input placeholder="2016-12-20 17:16:18" name="start" value="{{$booking['start_date_time']}}" id="start" type='text' class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="This field will be auto populated" type='text' name="end" value="{{$booking['end_date_time']}}" id="end" class="form-control" disabled />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('services') ? ' has-error' : '' }}">
                                    ...
                                    <select id="services" onchange="check_availability()" class="select2 form-control" name="services[]" multiple="true" value="{{ old('services') }}">
                                        @foreach($services as $service)
                                            <option @if(in_array($service->id, $booking['service_ids'])) selected @endif value="{{$service->id}}">{{$service->name}}</option>
                                        @endforeach
                                    </select>
