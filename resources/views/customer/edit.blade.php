...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" role="form" method="post" action="{{ url('/customer/'.$customer[0]->id) }}">
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input id="name" type="text" class="form-control" name="name" value="{{ $customer[0]->name }}">
                ...
                <div class="form-group{{ $errors->has('email_address') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input id="email_address" disabled type="email" class="form-control" name="email_address" value="{{ $customer[0]->email_address }}">
                ...
                <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input id="phone_number" type="text" class="form-control" name="phone_number" value="{{ $customer[0]->phone_number }}">
                ...
                <div class="form-group{{ $errors->has('send_reminders') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-1">
                        <input id="send_reminders" type="checkbox" class="checkbox" name="send_reminders" @if($customer[0]->send_reminders) checked @endif>
                ...
                <div class="form-group{{ $errors->has('is_student') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-1">
                        <select id="is_student" class="form-control" name="is_student">
                            <option value="1" @if($customer[0]->is_student) selected @endif>True</option>
                            <option value="0" @if(!$customer[0]->is_student) selected @endif>False</option>
                        </select>
                ...
                <div class="form-group{{ $errors->has('is_child') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-1">
                        <select id="is_child" class="form-control" name="is_child">
                            <option value="1" @if($customer[0]->is_child) selected @endif>True</option>
                            <option value="0" @if(!$customer[0]->is_child) selected @endif>False</option>
                        </select>
                ...
                <div class="form-group{{ $errors->has('is_military') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-1">
                        <select id="is_military" class="form-control" name="is_military">
                            <option value="1" @if($customer[0]->is_military) selected @endif>True</option>
                            <option value="0" @if(!$customer[0]->is_military) selected @endif>False</option>
                        </select>
                ...
                <div class="form-group{{ $errors->has('is_beard') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-1">
                        <select id="is_beard" class="form-control" name="is_beard">
                            <option value="1" @if($customer[0]->is_beard) selected @endif>True</option>
                            <option value="0" @if(!$customer[0]->is_beard) selected @endif>False</option>
                        </select>
                ...
                <div class="form-group{{ $errors->has('next_reminder') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input id="next_reminder" type="text" class="form-control" name="next_reminder" placeholder="2016-12-20 17:16:18" value="{{ $customer[0]->next_reminder }}">
